...
WwiseSettings::WwiseSettings()
{
	...
	project_settings.windows_platform_name = "wwise/project_settings/windows_platform_name";
	project_settings.windows_platform_path = "wwise/project_settings/windows_platform_path";
	project_settings.mac_platform_name = "wwise/project_settings/mac_platform_name";
	project_settings.mac_platform_path = "wwise/project_settings/mac_platform_path";
	project_settings.linux_platform_name = "wwise/project_settings/linux_platform_name";
	project_settings.linux_platform_path = "wwise/project_settings/linux_platform_path";
	project_settings.ios_platform_name = "wwise/project_settings/ios_platform_name";
	project_settings.ios_platform_path = "wwise/project_settings/ios_platform_path";
	project_settings.android_platform_name = "wwise/project_settings/android_platform_name";
	project_settings.android_platform_path = "wwise/project_settings/android_platform_path";
...
{
	// Common User Settings
	add_setting(common_user_settings.root_output_path, "", Variant::Type::STRING,
			PROPERTY_HINT_DIR, "");
	...
	add_setting(spatial_audio_settings.transmission_operation, AkTransmissionOperation::AkTransmissionOperation_Default, Variant::Type::INT,
			PROPERTY_HINT_ENUM, "Add, Multiply, Max");
	...
	add_setting(project_settings.create_subfolders_for_generated_files, false, Variant::Type::BOOL, PROPERTY_HINT_NONE,
			"", PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.windows_platform_name, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.windows_platform_path, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.mac_platform_name, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.mac_platform_path, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.linux_platform_name, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.linux_platform_path, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.ios_platform_name, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.ios_platform_path, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.android_platform_name, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
	add_setting(project_settings.android_platform_path, "", Variant::Type::STRING, PROPERTY_HINT_NONE, "",
			PROPERTY_USAGE_INTERNAL);
}
		...
		PropertyHint hint, const StringName& hint_string, int usage)
{
	...
	if (godot::ProjectSettings::get_singleton()->has_setting(name))
	{
		godot::ProjectSettings::get_singleton()->add_property_info(setting);
		godot::ProjectSettings::get_singleton()->set_as_basic(name, true);
		return;
	}

	godot::ProjectSettings::get_singleton()->set_setting(name, default_value);
	godot::ProjectSettings::get_singleton()->add_property_info(setting);
	godot::ProjectSettings::get_singleton()->set_as_basic(name, true);
}
