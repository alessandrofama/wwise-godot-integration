...
public:
	...
	struct ProjectSettings
	{
		...
		StringName windows_platform_name;
		StringName windows_platform_path;
		StringName mac_platform_name;
		StringName mac_platform_path;
		StringName linux_platform_name;
		StringName linux_platform_path;
		StringName ios_platform_name;
		StringName ios_platform_path;
		StringName android_platform_name;
		StringName android_platform_path;
	};
