...
void AkUtils::_bind_methods()
{
	...
	BIND_ENUM_CONSTANT(AK_ACTION_ON_EVENT_STOP);
	BIND_ENUM_CONSTANT(AK_ACTION_ON_EVENT_PAUSE);
	BIND_ENUM_CONSTANT(AK_ACTION_ON_EVENT_RESUME);
	BIND_ENUM_CONSTANT(AK_ACTION_ON_EVENT_BREAK);
	BIND_ENUM_CONSTANT(AK_ACTION_ON_EVENT_RELEASE_ENVELOPE);
