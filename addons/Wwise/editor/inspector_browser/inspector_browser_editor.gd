...
var updating = false
var inspector_browser:BoxContainer = preload("res://addons/Wwise/editor/inspector_browser/inspector_browser.tscn").instantiate(PackedScene.GEN_EDIT_STATE_INSTANCE)
